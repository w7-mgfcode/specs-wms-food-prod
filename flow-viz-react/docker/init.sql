...
-- MOCK AUTH SCHEMA (Simulating Supabase Auth for Foreign Keys)
...
INSERT INTO auth.users (id, email) VALUES 
    ('00000000-0000-0000-0000-000000000001', 'admin@flowviz.com'),
    ('00000000-0000-0000-0000-000000000002', 'operator@flowviz.com');
...
INSERT INTO public.users (id, email, full_name, role) VALUES 
    ('00000000-0000-0000-0000-000000000001', 'admin@flowviz.com', 'System Admin', 'ADMIN'),
    ('00000000-0000-0000-0000-000000000002', 'operator@flowviz.com', 'John Operator', 'OPERATOR');
